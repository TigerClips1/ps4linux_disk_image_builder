...
import os #this is the ods mudule from cpython
cmd1 = "losetup /dev/loop5/linux.img" #this will excute the command
...
error2 = "that you don't have a tar.gz fil e or cant be foundss" #variable string that print an error on your screen
path = "/home/xxxx/" #variable string
path2 = '/newroot' #variable string
cmd3 = 'tar -xvf /home/linuxuser/directory where your tar.xz is locate/ then ame of the tar.xz' #variable string
path3 = "/home/linuxuser/Documents" #variable string
...
def disks(): #function to keep thing nice
    ...
    os.system("mkdir /newroot") #make a directory
    os.system("sudo mount /dev/loop5 /newroot") # munt the diskimage file
    os.chdir(path2) #change the os directory
    os.system(cmd3) #extrect tar.xz files
    extrect = os.popen("tar -xvzf /home/linuxuser/directory where your tar.gz is locate/ then name of the tar.gz") #extrect tar.gz file
    ...
    wget = os.popen("sudo pacman -Syy && sudo pacman -S wget") #function
